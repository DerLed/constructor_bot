...
button_hui = KeyboardButton('Иди на хуй')
button_00 = KeyboardButton('1')
button_01 = KeyboardButton('2')
button_02 = KeyboardButton('3')
button_10 = KeyboardButton('4')
button_11 = KeyboardButton('5')
button_12 = KeyboardButton('6')
button_20 = KeyboardButton('7')
button_21 = KeyboardButton('8')
button_22 = KeyboardButton('9')

greet_kb = ReplyKeyboardMarkup(resize_keyboard=True)
greet_kb.row(button_00, button_01, button_02)
greet_kb.row(button_10, button_11, button_12)
greet_kb.row(button_20, button_21, button_22)
